...
parser.add_argument("--u", type=str, default=None, help="Control input (action) as a function of time."
...
parser.add_argument("--tmax", type=float, default=200.0, help="Duration of the simulation.")
parser.add_argument("--no_display", action="store_true", help="Set this to not display the rendered video.")
parser.add_argument("--no_save", action="store_true", help="Set this to not save the rendered video.")
parser.add_argument("--render_fps", type=float, default=60.0, help="Frames per second of the rendered video "
...
parser.add_argument("--render_dpi", type=float, default=100.0, help="Resolution (dots per inch) of the rendered video "
                    "(large values will take a longer time to generate and may be incorrect in the displayed video "
                    "but will be correct in the saved one). Default is 100 DPI.")
parser.add_argument("--render_speed", type=float, default=1.0, help="Speed of the rendered video, "
